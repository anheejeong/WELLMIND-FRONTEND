...
const dummyReportData = [
  ...
  {
    title: '3. 권장사항 및 해결책',
    description: `안희정 직원의 건강을 보호하고 업무 효율성을 높이기 위해 다음과 같은 해결책을 제안합니다.
...
* **근무 시간 조절:** 가능하다면, 출근 시간을 조정하거나 유연 근무제를 활용하는 방안을 검토하여, 장거리 통근으로 인한 스트레스를 줄이는 것이 좋습니다.`,
  },
  {
    ...
    description: `안희정 직원은 239일 중 94일(39.33%) 야근을 하였으며, 평균 초과 근무 시간은 1시간 45분 49초입니다.  이는 과도한 업무량으로 인한 만성 피로, 수면 부족, 스트레스 누적을 야기할 수 있습니다.  장기간 지속될 경우, 심혈관 질환, 소화기 질환, 면역력 저하 등 심각한 건강 문제로 이어질 위험이 높습니다.  또한, 개인 생활의 균형을 깨뜨려 우울증이나 불안감을 증가시킬 수 있습니다.`,
  },
  {
    title: '5. 야근 관련 권장사항',
    description: `안희정 직원의 건강을 보호하고 지속 가능한 업무 환경을 조성하기 위해 다음과 같은 권장 사항을 제안합니다.
